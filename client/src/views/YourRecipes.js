...
export default function YourRecipes(props) {
    ...
    const callToAPI = async () => {//receives keywords 
        try {
            ...
            console.log(test)
            const url = `https://thepantryapp.herokuapp.com/https://api.edamam.com/api/recipes/v2?type=public&beta=true&q=${test}&app_id=${process.env.REACT_APP_EDAMAM_APP_ID}&app_key=${process.env.REACT_APP_EDAMAM_APP_KEY}`
